...
* content
{:toc}
- ![](https://github.com/qq1773304209/lazy.github.io/blob/master/_posts/%E5%9B%BE%E7%89%87/dup/file.png)

![](https://github.com/qq1773304209/lazy.github.io/blob/master/_posts/%E5%9B%BE%E7%89%87/dup/file-1.png)
...
- 其实我理解的dup就是复制oldfd这个描述符，而这个返回的新的描述符和oldfd指向同一个文件表项，然后他们就可以一起共享这个表啦，就这么简单，下面我画了张图，看图简单点
  ...
  ![](https://github.com/qq1773304209/lazy.github.io/blob/master/_posts/%E5%9B%BE%E7%89%87/dup/dup.png)
...
dup2与dup区别是dup2可以用参数newfd指定新文件描述符的数值。若参数newfd已经被程序使用，则系统就会将newfd所指的文件关闭，若newfd等于oldfd，则返回newfd,而不关闭newfd所指的文件。 这是复制的，简化了一点，哈哈，接下来来个有意思的，看图![](https://github.com/qq1773304209/lazy.github.io/blob/master/_posts/%E5%9B%BE%E7%89%87/dup/dup2.png)
