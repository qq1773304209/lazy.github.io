...
* content
{:toc}
- ![](https://github.com/qq1773304209/lazy.github.io/tree/master/_posts/图片/dup/file.png)

![](https://github.com/qq1773304209/lazy.github.io/tree/master/_posts/图片/dup/file-1.png)
...
dup2与dup区别是dup2可以用参数newfd指定新文件描述符的数值。若参数newfd已经被程序使用，则系统就会将newfd所指的文件关闭，若newfd等于oldfd，则返回newfd,而不关闭newfd所指的文件。 这是复制的，简化了一点，哈哈，接下来来个有意思的，看图![](https://github.com/qq1773304209/lazy.github.io/tree/master/_posts/图片/dup/dup2.png)
